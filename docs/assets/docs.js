(function () {
  ...
  function mount() {
    ...
    function deleteFile(name) {
      ...
      return apiFetch("/docs/files?name=" + encodeURIComponent(name), { method: "DELETE", headers: jsonHeaders() })
        .then(function (r) {
    ...
    function loadFiles() {
      return apiFetch("/docs/files", { headers: jsonHeaders() })
        .then(function (r) {
          if (!ensureAuthed(r)) return [];
          return r
            .json()
    ...
    function refreshStatus() {
      return apiFetch("/docs/status", { headers: jsonHeaders() })
        .then(function (r) {
          if (!ensureAuthed(r)) return {};
          return r
            .json()
    ...
    btnUp.addEventListener("click", function () {
      ...
      apiFetch("/docs/upload", { method: "POST", headers: authHeader(), body: fd })
        .then(function (r) {
          if (!ensureAuthed(r)) return {};
          return r
            .json()
    ...
    btnBuild.addEventListener("click", function () {
      btnBuild.disabled = true;
      apiFetch("/docs/build", { method: "POST", headers: jsonHeaders() })
        .then(function (r) {
          if (!ensureAuthed(r)) return {};
          return r
            .json()
